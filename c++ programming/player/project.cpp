...
void display(Player *arr)
{
	...
	for(i=0;i<t;i++)
	{
		cout<<"\njersey no. "<<arr[i].getJersey()<<": "<<arr[i].getName()<<" player played "<<arr[i].getNoOfMatch()<<" matches \nhe made "<<arr[i].getRun()<<" runs and took "<<arr[i].getWicket()<<" wickets\n";
	}
}

...
class SalesMan:public Employee	//step 1
{
	...
	void setIncentive(double in)		//extra setters(mutator) required for Sales manager
	{
		this->incentive=in;
	}
	...
	double getIncentive()		//extra getters(accessor) required for sales manager
	{
